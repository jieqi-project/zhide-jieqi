...
function randomLotSrc(){const n=Math.floor(Math.random()*7)+1;return `./assets/lots/lots-${n}.svg`}
...
function drawFortune(){const img=document.getElementById("fortuneImg");const src=randomLotSrc();img.src=src;fortuneTitle.style.display="none";fortuneGrade.style.display="none";fortuneText.style.display="none";fortuneCard.classList.remove("show");fortuneCard.style.zIndex="5";void fortuneCard.offsetWidth;fortuneCard.classList.add("show");showActions()}
